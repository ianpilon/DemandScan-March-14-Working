...
const JTBD_PRIMARY_GOAL_STEPS = [
  ...
  { threshold: 20, label: "Identifying primary goals..." },
  { threshold: 40, label: "Extracting job statements..." },
  { threshold: 60, label: "Evaluating priorities..." },
  { threshold: 80, label: "Finalizing JTBD analysis..." }
];
